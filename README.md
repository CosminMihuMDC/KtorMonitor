...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("ro.cosminmihu.ktor:ktor-monitor-logging:1.7.5")
        }
    }
}
```
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("ro.cosminmihu.ktor:ktor-monitor-logging-no-op:1.7.5")
        }
    }
}
```
...
[![Kotlin](https://img.shields.io/badge/2.2.20-white?logo=kotlin&logoColor=white&color=7F52FF)](http://kotlinlang.org)
[![Compose Multiplatform](https://img.shields.io/badge/1.10.0-white?logo=jetpackcompose&logoColor=white&color=4284F3)](https://www.jetbrains.com/lp/compose-multiplatform)
...
[![Ktor](https://img.shields.io/badge/3.3.1-white?logo=ktor&logoColor=white&color=087CFA)](https://ktor.io)
