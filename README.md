...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("ro.cosminmihu.ktor:ktor-monitor-logging:1.10.1")
        }
    }
}
```
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("ro.cosminmihu.ktor:ktor-monitor-logging-no-op:1.10.1")
        }
    }
}
```
...
```kotlin
dependencies {
    debugImplementation("ro.cosminmihu.ktor:ktor-monitor-logging:1.10.1")
    releaseImplementation("ro.cosminmihu.ktor:ktor-monitor-logging-no-op:1.10.1")
}
```
...
[![Kotlin](https://img.shields.io/badge/2.3.0-white?logo=kotlin&logoColor=white&color=7F52FF)](http://kotlinlang.org)
...
[![Ktor](https://img.shields.io/badge/3.4.0-white?logo=ktor&logoColor=white&color=087CFA)](https://ktor.io)
[![SQLDelight](https://img.shields.io/badge/2.2.1-white?logo=sqlite&logoColor=white&color=003B57)](https://sqldelight.github.io/sqldelight)
